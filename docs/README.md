...
- `docs/research/`: raw research artifacts and source material
- `docs/research/2026-03-28-food-access-program-benchmark-dataset/`: structured benchmark table for comparable food-access programs
...
- Pull facts from them only when you need historical context.
- If an archived doc becomes relevant again, copy the needed material into an active doc instead of editing the archived original.
